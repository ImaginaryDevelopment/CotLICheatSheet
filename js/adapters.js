...
(function (exports, exposeYourself) {
    ...
    exports.parseLoot = (crusaders, lootData) => {
        ...
        var lootMapped = lootData
            ...
            if (loot.count)
                result.countOrLegendaryLevel = loot.count;
    ...
    exports.crusaderFilter = (ownedCrusaderIds, crusader, filterOwned, filterTags, isBuildingFormation, formationIds, ep, epFilterInput) => {
        ...
        var tagFilter = Object.keys(filterTags).map(function (tagId) {
    ...
    var comparer = (a, b) => (a < b ? -1 : b < a ? 1 : 0);
    var getSortMult = sortType => (sortType === "up" ? 1 : sortType === "desc" ? -1 : 0);
    var slotComparer = sortType => (a, b) => getSortMult(sortType) * comparer(a.slot, b.slot);
    var epComparer = (sortType, map) => (a, b) => getSortMult(sortType) * comparer(map[a.id], map[b.id]);
    var nameComparer = sortType => (a, b) => getSortMult(sortType) * comparer(a.displayName, b.displayName);
    ...
    exports.sortCrusaders2 =
        ...
        (crusaders, fComparisons) => {
            ...
            var sorted = copy.sort((a, b) => {
                var comparisonResults = fComparisons.reduce((prev, fn) => {
    ...
    exports.Talents = (() => {
        ...
        my.getWellEquippedDps =
            mainDpsEpics => lvl => 0.2 * lvl * mainDpsEpics;
        /**
